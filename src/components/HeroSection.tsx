      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-end">
          ...
          transform: `translateY(${descOffset}px)`
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-sm leading-relaxed">We lead, design and help build strategic solutions for products, digital experiences and brands that play meaningful roles in people's lives.</p>
          </div>
        </div>
      </div>
    </section>;
